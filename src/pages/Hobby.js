...
function Hobby() {
  return (
    <div className="hobby-page" style={{marginTop:'80px',fontFamily:'Karla'}}>
      ...
      <p>
        In my free time, I love to explore new places, read books, and experiment with cooking. These hobbies not only provide relaxation but also fuel my creativity.
      </p>
    </div>
  );
}
